  ...
  "node_modules/next/dist/server/app-render/staged-rendering.js"(exports2) {
    ...
    function makeDevtoolsIOPromiseFromIOTrigger(ioTrigger, displayName, resolvedValue) {
      const promise = new Promise((resolve4, reject2) => {
        ioTrigger.then(resolve4.bind(null, resolvedValue), reject2);
      });
  ...
  "node_modules/react/cjs/react.development.js"(exports2, module2) {
    ...
    "production" !== process.env.NODE_ENV && (function() {
      ...
      function recursivelyFlushAsyncActWork(returnValue, resolve4, reject2) {
        ...
        0 < ReactSharedInternals.thrownErrors.length ? (queue = aggregateErrors(ReactSharedInternals.thrownErrors), ReactSharedInternals.thrownErrors.length = 0, reject2(queue)) : resolve4(returnValue);
      }
...
async function awaitSubmissionOperation(operation, deadline) {
  ...
  try {
    return await new Promise((resolve4, reject2) => {
      ...
      try {
        void operation().then(resolve4, reject2);
      } catch (error) {
        reject2(error);
      }
    });
...
async function main() {
  ...
  const chain = JSON.parse((0, import_node_fs6.readFileSync)(chainPath, "utf8"));
  ...
  const results = await Promise.all(uniqueAgentIds.map((agentId) => startRunnerV2Bootstrap({
    ...
    runId,
    agentId,
    chainId: chain.id || (0, import_node_path6.basename)(chainPath, ".json"),
    chainName: chain.name || chain.id || (0, import_node_path6.basename)(chainPath, ".json"),
