#!/usr/bin/env node
// GENERATED FROM web/lib/runner-v2/job-worker.ts - DO NOT EDIT. Rebuild: node scripts/build-runner-bundles.mjs
"use strict";
...
child.on("close", async (code) => {
  ...
  job.completedAt = job.status === "complete" ? (/* @__PURE__ */ new Date()).toISOString() : void 0;
  job.result = result;
  try {
    persistJob(job);
  } catch (writeErr) {
