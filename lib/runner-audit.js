#!/usr/bin/env node
// GENERATED FROM web/lib/system/audit-cli.ts - DO NOT EDIT. Rebuild: node scripts/build-runner-bundles.mjs
"use strict";
...
function shipAuditEntry(entry, paths, namespaceId2) {
  ...
  const shipper = (0, import_node_path.join)(config_default.codeRoot, "lib", "runner-audit-ship.js");
  if (!(0, import_node_fs.existsSync)(shipper)) return Promise.reject(new Error(`Audit shipper is missing: ${shipper}`));
  const child = (0, import_node_child_process.spawn)(process.execPath, [shipper, "ship"], {
    detached: true,
