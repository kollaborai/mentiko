...
assert.doesNotMatch(functions, /\bnew-agent-session\b/);
assert.doesNotMatch(functions, /\bMENTIKO_CLI\b/);
...
console.log("PASS: standalone spec launch is TypeScript-owned; generic shell agent launch is retired");
