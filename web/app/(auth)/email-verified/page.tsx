...
function EmailVerifiedContent() {
  ...
  // sanitize redirectTo — only allow relative paths to prevent open redirect / javascript: injection
      ...
      <div className="w-full max-w-sm">
        <div className="bg-card rounded-md p-6">
          <div className="text-center mb-6">
            <h1 className="text-lg font-semibold mb-2">Verification in progress</h1>
    ...
    <div className="w-full max-w-sm">
      <div className="bg-card rounded-md p-6">
        <div className="text-center mb-6">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-12 w-12 mx-auto mb-4 text-green-500">
