...
export interface KnowledgeGraphProps {
	...
	zoomToFit?: boolean;
	/** Override force simulation charge strength (default: -800) */
	chargeStrength?: number;
	/** Override force link distance (default: 150) */
	linkDistance?: number;
}
	...
	(
		...
		useEffect(() => {
			...
			if (zoomToFit) {
				...
				// Also fit after a delay in case simulation cools before fully settling
		...
		}, [nodes, links, onNodeClick, onNodeHover, showLinkLabels, centerNodeId, zoomToFit, chargeStrength, linkDistance]);
