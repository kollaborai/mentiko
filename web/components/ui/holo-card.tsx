	...
	const FrontContent = (
		<div className="pointer-events-none absolute z-[2] flex h-full w-full flex-col items-start justify-end p-3 text-white transition">
			...
			<div className="absolute top-4 left-0 flex w-full justify-between px-3">
				{branding.logo && (
					<div className="rounded-full bg-white/30 p-1 px-2 text-xl font-light text-white/70 backdrop-blur-md">
						<Image
							src={branding.logo}
				...
				{badge && (
					<div className="rounded-full bg-white/20 p-1 px-4 text-xl font-light text-white/70 backdrop-blur-md">
						{badge}
					</div>
				)}
			</div>
			...
			<div className="relative flex w-full flex-col gap-1 overflow-hidden rounded-2xl bg-black/20 p-3 backdrop-blur-md">
				<div className="text-4xl font-black tracking-tighter text-white">{name}</div>
				{subtitle && (
		...
		<div className="pointer-events-none absolute z-[2] flex h-full w-full flex-col items-start justify-between p-3 text-white">
			<div className="flex w-full flex-col gap-4">
				...
				<div className="flex items-center justify-between">
					...
					{badge && (
						<div className="rounded-full bg-white/20 p-1 px-3 text-sm font-medium tracking-wide text-white/70 backdrop-blur-md">
							{badge}
						</div>
					)}
				</div>
				...
				<div className="relative overflow-hidden rounded-2xl bg-black/20 p-4 backdrop-blur-md">
					<div className="mb-2 text-2xl font-black tracking-tighter text-white">
						{name}
					</div>
					{subtitle && (
