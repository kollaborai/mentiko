...
import {
	ArrowUp2Filled,
	AddFilled as PlusSignIcon,
	SettingFilled as ToolsIcon,
} from "@aliimam/icons";
...
export const Composer: FC<ComposerProps> = ({
	...
	function handleToolSelect(match: SlashCommandMatch) {
				...
				<div className="flex items-center justify-between px-2 pt-1">
					<div className="flex items-center gap-1">
						...
						<div className="relative">
							...
							>
								<PlusSignIcon size={23} className="text-zinc-500 dark:text-zinc-400" />
							</button>
