...
const TERMINAL_REASON_LABELS: Record<AgentAttemptTerminalReason, string> = {
  ...
  instruction_delivery_ambiguous: "Instruction delivery could not be proven after coordinator loss",
  interrupted_bootstrap_changes: "Interrupted bootstrap left workspace changes for review",
  launch_coordinator_interrupted: "Launch coordinator stopped before instruction delivery",
