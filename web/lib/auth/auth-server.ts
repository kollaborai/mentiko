...
import type { AuditExecOptions, AuditLogMetadata } from "../api/audit-exec";
            ...
            create: {
              ...
              after: async (user: any) => {
                try {
                  ...
                  try {
                    const { createLinuxUser } = await import("../workspaces/linux-users");
