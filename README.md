...
tools like Claude Code, Codex, Kollabor, Grok, OpenCode, Antigravity CLI, and custom
...
| --- | --- |
| Agent harness runtime | Managed PTY sessions for Claude Code, Codex, Kollabor, Grok, OpenCode, Antigravity CLI, and custom terminal tools |
